...
class get_buxfer_accounts:
    ...
    def wait_for_sync_to_complete(self):
        ...
        if retries == 2:
            logger.error("Syncing status did not disappear after multiple retries.")
    ...
    def alert_monday(self):
        ...
        if self.account_sync_status!="Login Issue":
            ...
            time.sleep(3)
        updater.update_status(self.user_id, self.account_sync_status,out_of_sync_accounts)
